...
![](img/rstudio.jpeg){ width=10% } ![](img/ggplot2.png){ width=10% } ![](img/tidyverse.png){ width=10% } ![](img/tidymodels.png){ width=10% }
...
+ Universidad de Córdoba.<br/><br/>
  - Dr. José R. Caro <img src="https://img.icons8.com/external-kiranshastry-lineal-kiranshastry/16/000000/external-email-interface-kiranshastry-lineal-kiranshastry.png"/>
...
**Lugar:** Aula de Geoespaciales, 2a Planta. [Edificio Ramón y Cajal](https://www.uco.es/campus_rabanales/planos/2-uncategorised/20-plano-general-del-campus). Campus Universitario de Rabanales.
...
#### Datos del [curso](https://github.com/jdieramon/CursoAnalisisDatos/tree/master/datos)
<br>
...
**¿Necesitas ayuda?**
  ...
  **Si tienes alguna duda o inquietud, puedes hablar con Lola Pérez o José Die.**
...
* 5a edición: Universidad de Córdoba, 09-17 DIC 2020.  
